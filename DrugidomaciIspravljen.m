...
M11=[1;1]; S11=[4 1.1; 1.1 2];
M12=[6;4]; S12=[3 -0.8;-0.8 1.5];
M21=[7;-4]; S21=[2 1.1; 1.1 4];
M22=[6;0]; S22=[3 0.8;0.8 0.5]; 
P11=0.6; P12=0.4; P21=0.55; P22=0.45;
[Fi11,L11]=eig(S11); T11=Fi11*L11^0.5;
[Fi12,L12]=eig(S12); T12=Fi12*L12^0.5;
[Fi21,L21]=eig(S21); T21=Fi21*L21^0.5;
[Fi22,L22]=eig(S22); T22=Fi22*L22^0.5;
...
xlabel('X1');
ylabel('X2');
title('Dve bimodalne dvodimenzione klase');
...
prag23=f2max*0.05;
figure(1);
contour(x,y,f1',[prag11 prag11],'k','LineWidth',2); hold on;
contour(x,y,f1',[prag12 prag12],'k','LineWidth',2)
contour(x,y,f1',[prag13 prag13],'k','LineWidth',2)
contour(x,y,f2',[prag21 prag21],'k','LineWidth',2)  
contour(x,y,f2',[prag22 prag22],'k','LineWidth',2)
contour(x,y,f2',[prag23 prag23],'k','LineWidth',2)
...
hold all;
plot(X1(1,:),X1(2,:),'b*');
contour(x,y,h',[0 0],'LineWidth',2);
legend('Klasa 2','Klasa 1','Klasifikator','Location','SouthWest');
xlabel('X1');
ylabel('X2');
title('Dve bimodalne dvodimenzione klase');
hold off;
...
hold all;
plot(X1(1,:),X1(2,:),'b*');
contour(x,y,h',[Temp Temp],'o','LineWidth',2);
xlabel('X1');
ylabel('X2');
title('Dve bimodalne dvodimenzione klase');
hold on;
...
figure(3);
contour(x,y,h',[Temp Temp],'k','LineWidth',2);
hold on;
...
figure(3);
contour(x,y,h',[Temp Temp],'c','LineWidth',2);
legend('Klasa 2','Klasa 1','C12=C21','C12=5*C21','C21=5*C12','Location','SouthWest');
hold off;
